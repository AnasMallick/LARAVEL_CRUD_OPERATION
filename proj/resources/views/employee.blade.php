        ...
        <div class="row justify-content-center mt-3">
            <div class="col-6 border rounded-3 shadow">  
                <form action="{{url('/employee')}}" method="post">
                    @csrf
                    <div class="mb-3 mt-3">
                    <input type="text" name="emp_name" placeholder="Enter Your Name" class="form-control mt-3" id=""><br>
                    <input type="text" name="emp_age" placeholder="Enter Your Age" class="form-control" id=""><br>
                    <input type="text" name="emp_salary" placeholder="Enter Your Salary" class="form-control" id=""><br>
